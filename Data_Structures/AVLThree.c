//arvore AVL (Adelson-Velsky and Landis) é uma árvore binária de busca balanceada.
// Ela garante que a diferença de altura entre as subárvores esquerda e direita de qualquer nó seja no máximo 1, o que permite operações de busca, inserção e remoção em tempo logarítmico.
